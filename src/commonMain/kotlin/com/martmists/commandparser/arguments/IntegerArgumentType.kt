...
class IntegerArgumentType<C : Context> private constructor(private val radix: Int, private val range: IntRange) :
    ArgumentType<C, Int>() {
    ...
    companion object {
        fun <C : Context> int(min: Int = Int.MIN_VALUE, max: Int = Int.MAX_VALUE, radix: Int = 10) =
            IntegerArgumentType<C>(radix, min..max)
